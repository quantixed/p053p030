...
# Load in the files
my_files <- list.files(analysisdir,pattern='*.rds',full.names = TRUE)
...
# Save the plots
ggsave("./output/combined_plot_Plot.pdf", plot = combined_plot, width = 83, height = 132.885, units = 'mm', useDingbats = FALSE)
