...
# Output is a dataframe saved as .rds in Output/Data for combining and further processing
# Written by James Shelford, generalised by Stephen Royle

# log.txt needs to be in the experiment folder
...
fileName <- paste0("Output/Data/dataframe_", folderName, "_interphase.rds")
